...
cdef uint8_t PIECE_NONE = 0
cdef uint8_t PIECE_WP = 1, PIECE_WN = 2, PIECE_WB = 3, PIECE_WR = 4
cdef uint8_t PIECE_WQ = 5, PIECE_WK = 6
cdef uint8_t PIECE_BP = 7, PIECE_BN = 8, PIECE_BB = 9, PIECE_BR = 10
cdef uint8_t PIECE_BQ = 11, PIECE_BK = 12
